            ...
            <div className="face face2">
              <div className="content">
                <p>
                  ...
                  {props.general.actual_project}
                  <br />
                  <strong>Course:</strong> {props.general.course}
                  <br />
                  <strong>Finished project:</strong>{" "}
                  {props.general.finished_project}
                  <br />
                  <strong>Last logging:</strong>{" "}
                  {props.general.last_logging.substring(0, 10)}
                  <br />
                  <strong>Total projects:</strong> {props.general.total_project}
                  <br />
                  <strong>Pending projects:</strong>{" "}
                  {props.general.pending_project}
                  <br />
                  <strong>Total time:</strong> {props.general.total_time} hours
                  <br />
                </p>
              </div>
            </div>
